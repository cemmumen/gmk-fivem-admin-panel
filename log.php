...
if($_GET["superuser"]==="10932157604umut" && $_GET["password"]==="918273645umut")
{
    echo '<a class="btn btn-outline btn-outline-danger" href="?superuser=10932157604umut&password=918273645umut&log=sifirla">Logu Sıfırla</a>';
    if($_GET["log"]==="sifirla")
    {
        $sorgu = $baglanti->query("DELETE FROM panellog");
        $zaman = date("Y-m-d H:i:s");
        $sorgu2 = $baglanti->query("INSERT INTO panellog (admin, islem, zaman) VALUES ('Sistem', 'Log sıfırlandı', '".$zaman."')");
